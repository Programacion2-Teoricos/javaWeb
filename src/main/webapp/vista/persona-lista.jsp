      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><%= p.getNombre() %></td>
            <td class="actions">
              <button disabled class="btn-disabled" title="Disponible en Fase 2">Editar</button>
              <button disabled class="btn-disabled" title="Disponible en Fase 2">Eliminar</button>
            </td>
          </tr>
          <% } } else { %>
          <tr>
